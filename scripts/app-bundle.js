...
define('components/updatebalance/updatebalance',['exports', 'aurelia-dependency-injection', '../../shared/services/transactionservice', '../../shared/state/sharedstate', '../../shared/services/accountservice', 'moment'], function (exports, _aureliaDependencyInjection, _transactionservice, _sharedstate, _accountservice, _moment) {
  'use strict';
  ...
  var TransactionService = exports.TransactionService = (_dec = (0, _aureliaDependencyInjection.inject)(_apiservice.ApiService), _dec(_class = function () {
    ...
    TransactionService.prototype.save = function save(transaction) {
      if (transaction.slug) {
        ...
        return this.apiService.post('/api/transactions/', transaction.transaction).then(function (data) {
          return data.transaction;
        });
      }
    };
